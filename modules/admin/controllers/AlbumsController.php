...
/**
 * AlbumsController Реализовывает CRUD для модели Albums.
 */
class AlbumsController extends Controller
 {
    ...
    /**
     * Отображает все записи модели Albums.
     * @return mixed
     */
    public function actionIndex() {
        ...
        return $this->render('index', [
            ...
            'title' =>  Albums::name(["МН","ИМ"])
        ]);
    }

    /**
     * Показывает одну запись модели Albums.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Создает запись запись модели Albums.
    ...
    /**
     * Обновляет существующую запись модели Albums.
    ...
    /**
    * Показывать измеения в модели Albums.
    * @param integer $id
    * @return mixed
    */
    ...
    /**
     * Удаляет запись из модели Albums.
    ...
    /**
     * Находит запись в модели Albums основыаясь на внешнем ключе.
     * Если запись не найдена, выбрасывает ошибку 404.
     * @param integer $id
     * @return Albums найденная запись
